...
<div class="container mt-5">
  <h2 class="text-center --bs-danger mb-4">Brains College Result</h2>
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('results.search') }}">
        ...
        <div class="form-group mb-3">
          ...
          <input type="text" name="rollno" id="roll_number" class="form-control" required placeholder="Enter your Roll Number">
        </div>
